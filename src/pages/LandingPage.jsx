          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {featured.map((gpt) => (
              <Link
                to={`/gpt/${gpt.id}`}
                key={gpt.id}
                className="bg-[#121a2c] p-4 rounded-xl border border-gray-700 shadow-md hover:border-purple-500 hover:shadow-purple-500/50 hover:scale-105 transition-all duration-300 ease-in-out transform block"
              >
                <img
